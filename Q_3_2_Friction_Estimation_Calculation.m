...
% Define gear ratio N (Assume 1 if not given)
N = 14;  
...
% Construct the regressor matrices for both positive and negative datasets
Phi_plus = [omega_m_plus, (1/N) * sign(omega_m_plus)];
Phi_minus = [omega_m_minus, (1/N) * sign(omega_m_minus)];

% Construct the torque vector
Y_plus = tau_m_plus;
Y_minus = tau_m_minus;
...
% Compute final friction parameter estimates
...
% Compute least squares residuals
...
% Define the range of x values (rad/s)
